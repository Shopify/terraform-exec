...
require (
	...
	// Pinned to hc-install main (unreleased) because v0.9.3 embeds an expired GPG key (expired 2026-04-18).
	// The fix (renewed key) is on main but not yet in a tagged release.
	// See: https://github.com/hashicorp/hc-install/issues/370
	github.com/hashicorp/hc-install v0.9.4-0.20260417160020-99a174c773dd
